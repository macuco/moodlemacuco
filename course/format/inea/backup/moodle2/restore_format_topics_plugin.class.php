...
/**
 * Specialised restore for format_inea
 *
 * @package   format_inea
 * @category  backup
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class restore_format_inea_plugin extends restore_format_plugin {
    ...
    public function after_restore_course() {
        ...
        $backupinfo = $this->step->get_task()->get_info();
        if ($backupinfo->original_course_format !== 'inea' || !isset($data['tags']['numsections'])) {
