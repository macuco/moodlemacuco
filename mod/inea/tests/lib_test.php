 ...
 * @since      Moodle 3.0
 */
class mod_inea_lib_testcase extends advanced_testcase {
    ...
    public function test_resource_view() {
        ...
        $resource = $this->getDataGenerator()->create_module('inea', array('course' => $course->id),
                                                            array('completion' => 2, 'completionview' => 1));
        $context = context_module::instance($resource->cmid);
        $cm = get_coursemodule_from_instance('inea', $resource->id);
        ...
        $this->assertInstanceOf('\mod_inea\event\course_module_viewed', $event);
        $this->assertEquals($context, $event->get_context());
        $moodleurl = new \moodle_url('/mod/inea/view.php', array('id' => $cm->id));
    ...
    public function test_get_coursemodule_info() {
        ...
        $resource1 = $generator->create_module('inea', array('course' => $course->id,
        ...
        $resource2 = $generator->create_module('inea', array('course' => $course->id,
        ...
        $fs->create_file_from_string($filerecord, 'Test');
        $resource3 = $generator->create_module('inea', array('course' => $course->id,
                'name' => 'R3', 'files' => $draftid));

        // Try get_coursemodule_info for first one.
        $info = inea_get_coursemodule_info(
    ...
    public function test_resource_core_calendar_provide_event_action() {
        ...
        $actionevent = mod_inea_core_calendar_provide_event_action($event, $factory);
