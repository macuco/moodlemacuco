...
class mod_resource_search_testcase extends advanced_testcase {
    ...
    public function setUp() {
        ...
        $this->resourceareaid = \core_search\manager::generate_areaid('mod_inea', 'activity');
    ...
    public function test_attach_files() {
        ...
        $fs->create_file_from_string($filerecord, 'Test inea file 2');

        $resource = $this->getDataGenerator()->create_module('inea', $record);
