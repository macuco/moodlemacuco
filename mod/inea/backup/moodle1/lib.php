...
/**
 * Inea conversion handler
 */
class moodle1_mod_inea_handler extends moodle1_mod_handler {
    ...
    public function get_paths() {
        return array(
            new convert_path(
                'inea', '/MOODLE_BACKUP/COURSE/MODULES/MOD/INEA',
                array(
                    'renamefields' => array(
                        'summary' => 'intro',
                    ),
    ...
    public function process_resource(array $data, array $raw) {
        ...
        $this->fileman = $this->converter->get_file_manager($contextid, 'mod_inea');
