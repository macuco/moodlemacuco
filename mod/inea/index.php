...
$event = \mod_inea\event\course_module_instance_list_viewed::create($params);
$event->add_record_snapshot('course', $course);
$event->trigger();

$strresource     = get_string('modulename', 'inea');
$strresources    = get_string('modulenameplural', 'inea');
$strsectionname  = get_string('sectionname', 'format_'.$course->format);
$strname         = get_string('name');
$strintro        = get_string('moduleintro');
$strlastmodified = get_string('lastmodified');

$PAGE->set_url('/mod/inea/index.php', array('id' => $course->id));
...
if (!$resources = get_all_instances_in_course('inea', $course)) {
...
foreach ($resources as $resource) {
    ...
    $table->data[] = array (
        ...
        format_module_intro('inea', $resource, $cm->id));
}
