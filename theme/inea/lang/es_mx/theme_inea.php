...
/**
 * Strings for component 'theme_boost', language 'es_mx', branch 'MOODLE_33_STABLE'
 *
 * @package   theme_boost
...
$string['choosereadme'] = 'INEA es un tema moderno altamente configurable. El tema permite redireccionar directo al contenido a los estudiantes y asesores. Este tema está diseñado para usarse directamente, o como un tema paterno al crear temas nuevos usando Arranque (Bootstrap) 4.';
$string['configtitle'] = 'INEA';
$string['currentinparentheses'] = '(actual)';
$string['generalsettings'] = 'Configuraciones generales';
$string['pluginname'] = 'INEA (Boost)';
